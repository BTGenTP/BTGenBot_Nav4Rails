...
\begin{frame}
  ...
  $\Rightarrow$ Signature canonique du recovery Nav2 (« essayer planifier, sinon nettoyer costmap »). Le modèle apprendra surtout la \textbf{syntaxe} de ces motifs BT, pas leur sémantique métier. Pour NAV4RAIL, ces patterns 2D ne sont pas transférables tels quels : seule l'idée générale d'une séquence corrective reste pertinente.}
\end{frame}
